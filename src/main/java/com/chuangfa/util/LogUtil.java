...
public final class LogUtil {
    ...
    public static Logger getInfoLogger() {
        return Logger.getLogger("chuangfaInfoLogger");
    }
    ...
    public static Logger getWarnLogger() {
        return Logger.getLogger("chuangfaWarnLogger");
    }
    ...
    public static Logger getErrorLogger() {
        return Logger.getLogger("chuangfaErrorLogger");
    }
    ...
    public static Logger getDebugLogger() {
        return Logger.getLogger("chuangfaDebugLogger");
    }
    ...
    public static Logger getFatalLogger() {
        return Logger.getLogger("chuangfaFatalLogger");
    }
