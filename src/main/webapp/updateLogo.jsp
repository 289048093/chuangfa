...
<body>
	...
	<div class="main">
		<!-- banner start  -->
		<form method="post" action="indexManager/index!updateLogo.action">
			<s:iterator value="#request.files" var="item">

				<input type="radio" name="cloudContext.params.logoPic" value="<s:property value="#request.item.name"/>"
